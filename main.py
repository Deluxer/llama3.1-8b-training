...
instruction = "Create a function to calculate the sum of the sequence of the integers."
input = "[1,2,3,4,5]"
huggingface_model_name = "geradeluxer/Meta-Llama-3.1-8B-bnb-4bit"
...
def formatting_propmt_func(examples):
...
dataset = dataset.map(formatting_propmt_func, batched=True)
